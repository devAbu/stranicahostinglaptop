...
<!-- Sidebar ================================================== -->
	...
	<div class="span9">
		...
		<hr>
		<form onsubmit = "return CheckPassword(document.forma.pw)" id = "formica" name = "forma" action = "insertDB.php" method = "POST" style="margin-bottom:30px;">
		<div class="row">
		<h4>Personal Info</h4><br>
			<div class="col-md-2">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control" name="title" placeholder="Mr.">
				</div>
			</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="fName" placeholder="Chee Kin">
				</div>
			</div>
			...
			<div class="col-md-5">
				<div class="form-group">
					...
					<input type="text" class="form-control" name="lName" placeholder="Lim">
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="password" class="form-control" id = "pass" name="pw" placeholder="Password" required>
				</div>
			</div>
			
			<h4>Address Info</h4><br>
			<div class="col-md-12">
				<div class="form-group">
		...
		<button id ="reset" type ="reset" class="btn-item" style="float:right;">Cancel</button>
		<button id = "regfinish" type ="submit" class="btn-item"style="float:right; margin-right:10px;">Submit</button>
